...
namespace teletraffic {
      ...
      protected:
            virtual int ServiceInit();       // One-time (heavy) initialization

            virtual int ServiceStart();      // Fast start service
            virtual int ServiceIteration();  // Number of microseconds to wait before call ServiceIteration() again.
            virtual int ServiceStop();       // Fast stop service
